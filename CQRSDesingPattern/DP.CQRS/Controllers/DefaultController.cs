...
using DP.CQRS.CQRSPattern.Handlers;
using DP.CQRS.CQRSPattern.Queries;
using Microsoft.AspNetCore.Mvc;
using System;

namespace DP.CQRS.Controllers
{
	public class DefaultController : Controller
	{
		...
		[HttpPost]
		public IActionResult UpdateProduct(UpdateProductCommand model)
		{
			_updateProductCommandHandler.Handle(model);
			return RedirectToAction("Index");
		}
	}
}
